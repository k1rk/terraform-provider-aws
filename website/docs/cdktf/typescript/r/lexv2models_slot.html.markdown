 ...
 */
import { Lexv2ModelsSlot } from "./.gen/providers/aws/";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new Lexv2ModelsSlot(this, "example", {
      bot_id: awsLexv2ModelsBotExample.id,
      bot_version: awsLexv2ModelsBotVersionExample.botVersion,
      intent_id: awsLexv2ModelsIntentExample.id,
      locale_id: awsLexv2ModelsLocaleExample.localeId,
      name: "example",
    });
  }
}
